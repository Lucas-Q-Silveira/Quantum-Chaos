...
$
H = \sum_{i} \sum_{\alpha} J_\alpha\, S^\alpha_i S^\alpha_{i+1}
  + \sum_{i} \sum_{\alpha} N_\alpha\, S^\alpha_i S^\alpha_{i+2}
  + \sum_{i} \sum_{\alpha} A_\alpha \left(S^\alpha_i\right)^2
  + \sum_{i} \left( h_x S^x_i + h_z S^z_i \right)
$
